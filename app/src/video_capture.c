 ...
 * 
 * CMPT433
 * Further Modifications made by Lucas to remove unnecessary variables and support this code run 
 * as a separate thread. This lets us integrate video capture into a single program. 
 */
